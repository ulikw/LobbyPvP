...
[![Downloads](https://img.shields.io/spiget/downloads/126633?style=for-the-badge&label=Downloads&color=blue&logo=spigotmc&logoColor=white)](https://www.spigotmc.org/resources/126633/)
[![Rating](https://img.shields.io/spiget/rating/126633?style=for-the-badge&label=Rating&color=yellow&logo=spigotmc&logoColor=white)](https://www.spigotmc.org/resources/126633/)
...
# If enabled, the speed and the strength effects will be given when right-clicking.
right-click-ability:
  enable: true
  cooldown: 15

  # Right-click effects configuration
  speed:
    duration: 5
    amplifier: 0
  strength:
  ...
  # Live cooldown indicator while the ability recharges, plus a sound when it's ready again.
  # mode: actionbar (text) or xp-bar (uses your XP bar/level as a progress meter).
  cooldown-display:
    enable: true
    mode: actionbar
    ready-sound: ENTITY_EXPERIENCE_ORB_PICKUP

# If enabled, the player will receive the speed and the strength effects as Right-click above when killing another player.
speed-strength-on-kill:
  enable: true
...
# sound: any Bukkit Sound name.
#        Worth trying: UI_BUTTON_CLICK, BLOCK_LEVER_CLICK, BLOCK_NOTE_BLOCK_PLING.
